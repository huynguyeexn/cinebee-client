                ...
                <Card.Body>
                    <Row className='movie-detail--comment mb-4'>
                        <Col lg={1} sm={1} xs={2} className='movie-detail--img_comment'>
                            <Image
                                loader={() =>
                                    'https://dmitryvolkov.me/demo/hotflix2.1/main/img/user.svg'
                                }
                        ...
                        <Row className='movie-detail--comment1 mt-2'>
                            ...
                            <Card.Body className='pt-2 pb-2'>
                                <p className='d-flex align-items-center mb-0'><FaRegThumbsUp className='ml-2 mr-1 movie-detail--comment1--iconThumbsUp'/> 12 <FaRegThumbsDown  className='ml-3 mr-1 movie-detail--comment1--iconThumbsDown'/> 7</p>
                            </Card.Body>
                        </Row>
                    </Row>
                    <Row className='movie-detail--comment mb-4'>
                    ...
                    <Row className='movie-detail--comment mt-3'>
                        <textarea className='movie-detail--textarea' id="" cols={65} rows={6} placeholder='Bình luận...'></textarea>
