									...
									<div className="padding">
										...
										<div className="infor-user">
											<div className="form-group d-flex">
												...
												<div className="col-2"><span><FaUser /></span></div>
												<div className="col-10"><p> {profile?.username}</p></div>
											</div>
											<div className="form-group d-flex">
												...
												<div className="col-2"><span><IoMdPhonePortrait /></span></div>
												<div className="col-10"><p> {profile?.phone}</p></div>
												
											</div>
											<div className="form-group d-flex">
												{/* <label htmlFor="username"><MdEmail /></label>
												<input type="email" name="email"  className="col-md-12 col-form-label" value={profile?.email}/> */}
												<div className="col-2"><span><MdEmail /></span></div>
												<div className="col-10"><p>{profile?.email}</p></div>
											...
											<div className="form-group d-flex">
												...
												<div className="col-2"><span><IoMdHome /></span></div>
												<div className="col-10"><p>{profile?.address}</p></div>
											</div>
											<div className="form-group d-flex">
												...
												<div className="col-2"><span><MdDateRange /></span></div>
												<div className="col-10"><p> {profile?.birthday}</p></div>
												
											</div>
											<div className="form-group d-flex">
												<div className="col-2"></div>
												<div className="col-10"><p>Giới tính: {GENDER[profile?.gender]}</p> </div>
											</div>
